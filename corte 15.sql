...
WHERE Status1 = 'APROBADO'
    AND Fecha_Solicitud BETWEEN '2023-10-01' AND '2023-10-31'
	--AND 
	--AND Fecha_activacion_cuenta1 BETWEEN '2023-10-01' AND '2023-10-31'
    --AND Fecha_Solicitud < GETDATE()
	--AND Id_Socio <> 0
	AND Fecha_Corte = 'CORTE 15'
	---AND Id_Socio = '4'
	AND Producto1 IN ('9','8')
    AND NOT (
