WITH MontoGrupo AS (
    ...
    WHERE 
       ...
       ----- MCC_GIRO_COMERCIO = '07832' AND 
        ...
        LEFT(NUM_CUENTA, 6) IN ('481281', '481284', '403750', '481282', '446351', '481283') AND ---SE CAMBIA BINES POR SOCIO O SE AGREGAR BINES PLCC
        RFC_COMERCIO = 'SSH 9608016NA' ---SE CAMBIA DEPENDIENDO EL COMERCIO
)
