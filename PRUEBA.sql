SELECT
    ...
    FECHA_CONSUMO,
       CASE
					...
					, CASE 
					    WHEN NUM_CUENTA = '403750' THEN 'PROMODA'
						WHEN NUM_CUENTA = '481282' THEN 'GCC' 
						WHEN NUM_CUENTA = '481281' THEN 'SHASA'
						WHEN NUM_CUENTA = '481284' THEN 'SUBURBIA'
						WHEN NUM_CUENTA = '481283' THEN 'BODEGA'
						WHEN NUM_CUENTA = '446351' THEN 'C&A'
